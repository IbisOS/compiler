...
#line 21 "../../../binutils/binutils/sysinfo.y"
...
union YYSTYPE
{
#line 41 "../../../binutils/binutils/sysinfo.y"
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* $@1: %empty  */
#line 55 "../../../binutils/binutils/sysinfo.y"
      {
  switch (writecode)
    {
    case 'i':
...
#line 77 "../../../binutils/binutils/sysinfo.y"
        {
  switch (writecode) {
  case 'i':
  case 'p':
...
#line 1229 "sysinfo.c"
  ...
  case 6: /* $@2: %empty  */
#line 99 "../../../binutils/binutils/sysinfo.y"
      {
...
#line 150 "../../../binutils/binutils/sysinfo.y"
{
  switch (writecode) {
  case 'd':
    printf("};\n");
...
#line 1304 "sysinfo.c"
  ...
  case 12: /* $@3: %empty  */
#line 178 "../../../binutils/binutils/sysinfo.y"
        {
	  rdepth++;
	  switch (writecode)
	    {
...
#line 209 "../../../binutils/binutils/sysinfo.y"
        {
	  free (repeat);
...
#line 1357 "sysinfo.c"
  ...
  case 14: /* $@4: %empty  */
#line 228 "../../../binutils/binutils/sysinfo.y"
        {
	  switch (writecode)
	    {
	    case 'i':
...
#line 243 "../../../binutils/binutils/sysinfo.y"
        {
	  switch (writecode)
	    {
	    case 'i':
...
#line 1390 "sysinfo.c"
  ...
  case 16: /* $@5: %empty  */
#line 257 "../../../binutils/binutils/sysinfo.y"
        {name = (yyvsp[0].s); }
#line 1396 "sysinfo.c"
    break;

  case 17: /* it_field: '(' attr_desc '(' attr_type attr_size ')' attr_id $@5 enums ')'  */
#line 259 "../../../binutils/binutils/sysinfo.y"
        {
	  char *desc = (yyvsp[-8].s);
	  char *type = (yyvsp[-6].s);
	  int size = (yyvsp[-5].i);
...
#line 367 "../../../binutils/binutils/sysinfo.y"
              { (yyval.s) = (yyvsp[0].s); }
#line 1510 "sysinfo.c"
    break;

  case 19: /* attr_type: %empty  */
#line 368 "../../../binutils/binutils/sysinfo.y"
           { (yyval.s) = "INT";}
#line 1516 "sysinfo.c"
    break;

  case 20: /* attr_desc: '(' NAME ')'  */
#line 373 "../../../binutils/binutils/sysinfo.y"
        { (yyval.s) = (yyvsp[-1].s); }
#line 1522 "sysinfo.c"
    break;

  case 21: /* attr_size: NUMBER UNIT  */
#line 378 "../../../binutils/binutils/sysinfo.y"
        { (yyval.i) = (yyvsp[-1].i) * (yyvsp[0].i); }
#line 1528 "sysinfo.c"
    break;

  case 22: /* attr_id: '(' NAME ')'  */
#line 383 "../../../binutils/binutils/sysinfo.y"
                                { (yyval.s) = (yyvsp[-1].s); }
#line 1534 "sysinfo.c"
    break;

  case 23: /* attr_id: %empty  */
#line 384 "../../../binutils/binutils/sysinfo.y"
                { (yyval.s) = strdup ("dummy");}
#line 1540 "sysinfo.c"
    break;

  case 27: /* enum_list: enum_list '(' NAME NAME ')'  */
#line 392 "../../../binutils/binutils/sysinfo.y"
                                    {
	  switch (writecode)
	    {
	    case 'd':
...
#line 410 "../../../binutils/binutils/sysinfo.y"
